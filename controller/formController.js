...
doc.text(`Payment Status: ${singleForm.paymentStatus}`, {
  width: 410,
        ...
        //doc.rect(doc.x,0, 510, doc.y).stroke()





//console.log("single form photo",singleForm.uploadphoto);


// doc.image(root + "/"+singleForm.uploadphoto, {
//   fit: [250, 300],
//   align: 'center',
//   valign: 'center'
// });
// doc.image(root + "/"+singleForm.uploadsignature, {
//   fit: [250, 300],
//   align: 'center',
//   valign: 'center'
// });

///Users/shamshad/Desktop/NIA-HEROKU-HOST-TEST/Creating-NIA-Gallery-Feature/NIA-Gallery-feature/bhartiya-backend/62b43e4ca27fc6e0db9a59ca.pdf
